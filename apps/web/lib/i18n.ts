...
export const dict = {
    en: {
        ...
        'hero.stat.days': 'Days',
        'hero.countdown': 'Opening Ceremony',
        'time.days': 'Days',
        'time.hours': 'Hours',
        'time.minutes': 'Mins',
        'time.seconds': 'Secs',
        ...
        'fixtures.clearFilters': 'Clear filters',
    ...
    es: {
        ...
        'hero.stat.days': 'Días',
        'hero.countdown': 'Ceremonia de Apertura',
        'time.days': 'Días',
        'time.hours': 'Horas',
        'time.minutes': 'Min',
        'time.seconds': 'Seg',
        ...
        'fixtures.clearFilters': 'Limpiar filtros',
        ...
        'match.city': 'Ciudad',
        'match.group': 'Grupo',
        'match.back': 'Volver al calendario',
